...
public class EdificioHelper implements Serializable {
    ...
    public Edificio consultarEdificioId(String busqueda){//Este metodo es para usarlo en modificacion
        return ServiceFacadeLocator.getInstanceFacadeEdificio().consultaEdificioID(busqueda);
    }
